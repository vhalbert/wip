...
public abstract class Table {
    ...
    public Table(String name) {
    	this.name = name;
    	this.className =  org.teiid.reverseeng.util.Util.columnNameToMemberName(this.name);
    }
	/**
	 * @return String
	 * @see org.teiid.reverseeng.api.Table#getName()
	 */
	...
	/**
	 * @return String
	 * @see org.teiid.reverseeng.api.Table#getRemarks()
	 */
