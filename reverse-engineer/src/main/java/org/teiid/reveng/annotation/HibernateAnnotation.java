...
public class HibernateAnnotation implements AnnotationType {
	...
	static {
		...
		IMPORTS.add("import org.hibernate.search.annotations.Analyze;");
		IMPORTS.add("import org.hibernate.search.annotations.Field;");
		IMPORTS.add("import org.hibernate.search.annotations.Index;");
		IMPORTS.add("import org.hibernate.search.annotations.Indexed;");
		IMPORTS.add("import org.hibernate.search.annotations.Store;");
		IMPORTS.add("import org.hibernate.search.annotations.DateBridge;");
	 ...
	 * {@inheritDoc}
	 *
	 * @see org.teiid.reveng.api.AnnotationType#getAnnotation(org.teiid.reveng.api.Table)
	 */
	public String getAnnotation(Table t) {
//		@Indexed(index="Trade")
		return TABLE_INDEX + "(index=" + t.getClassName() + ")";
	}
	
	/**
	 * {@inheritDoc}
	 *
	 * @see org.teiid.reveng.api.AnnotationType#getAnnotation(org.teiid.reveng.api.Column)
	 */
...
//			@Field @DateBridge(resolution=Resolution.MINUTE)
	 ...
	 * {@inheritDoc}
	 *
	 * @see org.teiid.reveng.api.AnnotationType#getImports()
	 */
