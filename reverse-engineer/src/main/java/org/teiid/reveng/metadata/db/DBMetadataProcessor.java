...
import org.teiid.reveng.api.Column.NullType;
...
public final class DBMetadataProcessor implements MetadataProcessor {
	...
	public  void loadMetadata(Connection connection, String catalog, String schema, List<String> tableNames) throws Exception {
...
//		return column;
	...
	void setIndexes(DatabaseMetaData metadata, DBTable dbTable, String catalogName, String schemaName) throws SQLException {
