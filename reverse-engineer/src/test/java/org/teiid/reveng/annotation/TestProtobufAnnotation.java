...
public class TestProtobufAnnotation {
   ...
   @Test
    public void testTableAnnotation() throws Exception {
    	...
    	String tannotation = PROTOBUF.getAnnotation(parenta);
    	
    	assertTrue(tannotation.startsWith(ProtobufAnnotation.TABLE_INDEX));
   ...
   public void testIndexedColumnAnnotation() throws Exception {
   	...
   	String cannotation = PROTOBUF.getAnnotation(col1);
   	
   	assertTrue(cannotation.startsWith(ProtobufAnnotation.PROTODOC));
   	assertTrue(cannotation.indexOf(ProtobufAnnotation.INDEXED_YES) > 0);
   ...
   public void testNonIndexedAnnotation() throws Exception {
   	...
   	assertTrue(cannotation.startsWith(ProtobufAnnotation.PROTODOC));
   	assertTrue(cannotation.indexOf(ProtobufAnnotation.INDEXED_NO) > 0);
