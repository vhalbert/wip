...
public class TeiidEmbeddedRestWebServiceDataSource {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 server.initialize("org/teiid/example/webservices-as-a-datasource-config.xml");

		 server.startServer();
		 
		 server.deployVDB("restwebservice-vdb.xml");
		
		 Connection c = server.getConnection("jdbc:teiid:restwebservice", null);
