...
//		initCassandraProperties();
		 ...
		 server.initialize("org/teiid/example/cassandra-as-a-datasource-config.xml");
...
//		Connection c = server.getDriver().connect("jdbc:teiid:users", null);
		 ...
		 server.deployVDB("cassandra-vdb.xml");
		
		 Connection c = server.getConnection("jdbc:teiid:users", null);
