...
//	private static String DBNAME = "mydb" ;
	...
	public static void main(String[] args) throws Exception {
		 ...
		 server.initialize("org/teiid/example/mongodb-as-a-datasource-config.xml");

		 server.startServer();
		 
		 server.deployVDB("mongodb-vdb.xml");
		
		 Connection c = server.getConnection("jdbc:teiid:northwind", null);
