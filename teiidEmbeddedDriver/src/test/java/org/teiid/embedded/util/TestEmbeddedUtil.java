...
public class TestEmbeddedUtil {
	...
	@Test public void testSetProperties() throws Exception {			
		...
		EmbeddedUtil.setProperties(sc, props);

		Assert.assertEquals("data", sc.getParentDirectory());
		Assert.assertEquals(true, sc.isSupportsDirectQueryProcedure());
